...
{
    string nombre, descripcion, genero, clasificacion, consola, disponibilidad, categoria;
...
void Alta()
{
    ...
    for (int i = 0; i < alta; i++)
	{
        ...
        getline(cin, articulos[i].categoria);
...
void lista()
{
	...
	int j, resultado;
		int opcion2;
		printf("\tingrese una opcion de lista\n");
		printf("1.-Categoria\n");
    	printf("2.-Genero\n");
		...
		case 1: 
		 ...
		 cin.ignore();
		 getline(cin, evaluacion);
		 
		  for (int i = 0; i < alta; i++)
			{
			resultado = articulos[i].categoria.compare(evaluacion);
			j = i;
			j = j+1;
	...
	cin.ignore();
		 getline(cin, evaluacion);
		  ...
		  for (int i = 0; i < alta; i++)
			{
			resultado = articulos[i].genero.compare(evaluacion);
			j = i;
			j = j+1;
			if(articulos[i].disponibilidad == "ELIMINADO")
		{
    ...
    case 3:
	   ...
	   cin.ignore();
		 getline(cin, evaluacion);
		  ...
		  for (int i = 0; i < alta; i++)
			{
			resultado = articulos[i].clasificacion.compare(evaluacion);
			j = i;
			j = j+1;
			if(articulos[i].disponibilidad == "ELIMINADO")
		{
    ...
    case 4:
		...
		cin.ignore();
		 getline(cin, evaluacion);
		  ...
		  for (int i = 0; i < alta; i++)
			{
			resultado = articulos[i].consola.compare(evaluacion);	
			j = i;
			j = j+1;
			if(articulos[i].disponibilidad == "ELIMINADO")
		{
...
void modificar()
{
    ...
    printf("3.-genero del producto\n");
    printf("4.-clasificacion del producto\n");
    printf("5.-consola del producto\n");
    printf("6.-precio unitario del producto\n");
	scanf("%d",&opcion);
...
//DESCRIPCION
	...
	//categoria
	int longitud9=0, long9;
	
	for (int i = 0; i < alta; i++) 
	{
        if (articulos[i].categoria.length() > longitud9) 
		{
            longitud9 = articulos[i].categoria.length();
        }
	}
	if (longitud9<=9)
	{
...
//PRECIO UNITARIO
	...
	for (int i = 0; i < alta; i++)
	{
		...
		//no.item
			...
			//categoria
			if(articulos[i].categoria.length()<=9)
			{
				texto2 = articulos[i].categoria;
				archivo << texto2;
				a = longitud9 - articulos[i].categoria.length();
			}
			else
			{
				a=articulos[i].categoria.length();
				texto2 = articulos[i].categoria;
				archivo << texto2;
				a = longitud9 - a;					
			}
